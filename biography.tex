...
Dans cette sous-section, nous donnons un très brève analyse de l'œuvre.
...
Cette étude est accompagnée de son programme descriptif :\\
...
\subsubsection{IV \emph{Terek} (1900)}
...
La neuvième étude \emph{Harpes éoliennes} est un Adagio non tanto à 9/8, en si m, de forme A + cadence + B + cadence + C. L'usage extrêmement vituose des trémolots est un hommage à \emph{Chasse neige} des \emph{études d'execution transcendante} de Liszt (si$\flat$ m).
