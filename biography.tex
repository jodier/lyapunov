...
Cette expédition marque durablement Liapounov et lui fournit une inépuisable réserve de matériaux. Comme c'est le cas dans l'étude op.11 \no 8 (voir chapitre suivant), certains thèmes seront directement cités/réutilisés. Dans le catalogue des œuvre de Liapounov (voir annexe 1), nous pouvons compter 14 opus de chansons russes avec accompagnement au piano. Au fil des années suivante, c'est l'influance du \emph{Groupe des cinq} et plus particulièrement de Balakirev qui caractérisera le style de Liapounov.
