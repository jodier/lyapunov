...
\indent« J'ai commençé à composer mon second concerto pour piano. [$\cdots$] Je ne peux pas me défaire de l'influence du langage formel de Liszt. Quand il vient une écriture virtuose, je me sens complètement asservi par le pianisme lisztien. »\\
\indent Ce à quoi Balakirev répond :\\
\indent« Ne cherche pas à éviter le pianisme lisztien. Un bon compositeur ne doit pas se forcer, mais doit suivre ses tendances naturelles. [$\cdots$] Tu ne doit pas te sentir asservi parce lorsque tu utilises le pianisme lisztien, tu peux toujours afficher ta propre personnalité. »\\
...
Nous verrons par la suite que la musique de Liapounov ne se limite pas aux influences de Chopin et Liszt mais qu'elle est principalement inspirée par les éléments du folklore russe.
