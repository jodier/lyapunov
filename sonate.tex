...
\begin{tabular}{|l||l|l|l|l|l|}
 \hline
S.178 & Allegro & Antante & Fugato & Allegro & Coda\\
& 43\% & 17\% & 10\% & 20\% & 10\%\\
 \hline
 \hline
Op.27 & Allegro & Antante & Scherzando & Tempo I & Coda\\
& 41\% & 19\% & 15\% & 16\% & 8\%\\
 \hline
\end{tabular}
  \end{bigcenter}
  \caption{\label{sonate-liapounov-list1} Comparaison des proportions de la sonate S.178 de Liszt (en haut) avec les proportions de la sonate Op.27 de Liapounov (en bas).}
\end{figure}
...
\end{tabular}
  \end{bigcenter}
  \caption{\label{sonate-liapounov-list2} Comparaison de la structure de la sonate S.178 de Liszt (en haut) avec la structure de la sonate Op.27 de Liapounov (en bas).}
\end{figure}
